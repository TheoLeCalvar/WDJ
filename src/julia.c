...
// z.y = y;
    ...
    for (int j = 0; j < iterations; ++j) {
        mpfr_mul(r2, r, r, MPFR_RNDN);
        mpfr_mul(i2, i, i, MPFR_RNDN);
        mpfr_mul(ri, r, i, MPFR_RNDN);
        ...
        mpfr_add(i, ri, ci, MPFR_RNDN);

        mpfr_sub(r2, r2, i2, MPFR_RNDN);
        mpfr_add(r, r2, cr, MPFR_RNDN);

    }

    mpfr_clears(r2, i2, ri, ir2, NULL);
